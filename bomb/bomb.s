...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx                          // %rdx         = %rsi            = %rsp + $0x18
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                     // %rcx         = $0x4 + %rsi     = %rsp + $0x1C
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                    // %rax         = $0x14 + %rsi    = %rsp + $0x2C
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                     // $0x8 + %rsp  = %rax            = %rsp + $0x2C
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                    // %rax         = $0x10 + %rsi    = %rsp + $0x28
  401474:	48 89 04 24          	mov    %rax,(%rsp)                        // (%rsp)       = %rax            = $0x10 + %rsi    = %rsp - $0x18
